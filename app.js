...
async function loadStockDatabase() {
    ...
    try {
        ...
        console.log('  4개 파일 동시 로드 중...');
        const [part1, part2, part3, part4] = await Promise.all(loadPromises);
        
        console.log(`  ✓ Part 1: ${Object.keys(part1).length}개 종목`);
        console.log(`  ✓ Part 2: ${Object.keys(part2).length}개 종목`);
        console.log(`  ✓ Part 3: ${Object.keys(part3).length}개 종목`);
        console.log(`  ✓ Part 4: ${Object.keys(part4).length}개 종목`);
        
        // 4개 병합
        stockDatabase = { ...part1, ...part2, ...part3, ...part4 };
